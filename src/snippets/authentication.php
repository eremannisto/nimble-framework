...
// Dependencies
if (!class_exists('Notification')) Components::require('Notification'); 
...
class Security {
    ...
    public static function isAuthenticated(): bool{
        return isset($_SESSION['user']['authenticated']) && $_SESSION['user']['authenticated'] === true;
    }
    ...
    public static function signIn(string $email, string $password, string $token): bool{
        ...
        $query = $connect->prepare("SELECT * FROM `Users` WHERE `EmailAddress` = :email");
