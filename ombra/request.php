...
/**
 * Request class handles all request related methods,
 * such as getting and setting the GET and POST values,
 * the current protocol, request method, page, and url.
 * 
 * @version 1.0.0
 */
class Request {
     ...
     * 
     * @param bool $fullPath 
     * Whether to return the full path or just the page name.
     * 
     * @return string
     * The current page.
     */
    public static function page(bool $fullPath = FALSE): string {
        $page = $_GET['page'] ?? '';
        return $fullPath ? sprintf('%s/%s', Config::get('host'), $page) : $page;
    }
